...
(add poly poly2) ; (polynomial x (2 (scheme-number . 5)))

(define poly-poly (make-polynomial 'y (list (list 3 poly) )))
(define poly-poly2 (make-polynomial 'y (list (list 3 poly2))) )

(add poly-poly poly-poly2) ; (polynomial y (3 (polynomial x (2 (scheme-number . 5))))
